<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href=""><img src="public/images/logotaobao2.png" alt="Logo Construction"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> (+84) 094 383 2101
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> ptanh2101@gmail.com
        </div>
      </div>

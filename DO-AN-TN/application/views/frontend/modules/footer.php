    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logotaobao.png" style="width: 80%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                    Taobao Order<br>
                    Nhanh chóng - Chất lượng - Giá cả hợp lý
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>44 Mậu Dương, tp.Hưng Yên, Hưng Yên</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>094 383 2101</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:vanhiepp1998@gmail.com">ptanh2101@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>

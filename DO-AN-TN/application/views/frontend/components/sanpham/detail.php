					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Khuyến mãi 2 <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
							...
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Bảo hành 1 đổi 1 trong 48h sau khi nhận hàng nếu có bất kỳ lỗi từ nhà sản xuất</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
